...
<head>
    ...
    <title>Préparation Envoi du Livre</title>
...
<section id="header">
    ...
    <div>
        ...
        <li><a href="../../accueil">Accueil</a></li>
            <li class="active"><a href="../../livres-tarawih">Livres</a><i></i></li>
            <li><a href="../../articles-tarawih">Articles</a><i></i></li>
            <li><a href="../../faq-tarawih">FAQ Tarawih</a><i></i></li>
...
<!------------------------END HEADER------------------------------->
    <div id="pagedulivre" style='background-image: url("<?php echo 'img-livre/' . $livres_tarawih['image_principale'];?>")'  class="container-fluid">
        <h1>Préparation de l'envoi du livre</h1>
    </div>
    <section id="confirmationcommandelivre">
        <div class="confirmation-commande">
            <h3>Vous venez de confirmer la préparation de l'envoi du livre.</h3>
            <p>Vous allez recevoir un mail (Vérifier vos SPAMS) sous 24 heures vous confirmant l'envoi de votre livre.</p>
    </section>
