...
<script src="https://cdn.by.wonderpush.com/sdk/1.1/wonderpush-loader.min.js" async></script>
    ...
    <link rel="stylesheet" href="livres-tarawih/style-livre-tarawih.css">
</head>
<body>
...
<!------------------------END HEADER------------------------------->
    ...
    <h1>Livraison du Livre</h1>
        <p class="sub3">Mentions Obligatoires et Destination Hors Europe</p>
    </div>
    <section id="confirmationcommandelivre">   
        <div class="confirmation-commande">
        <h3>Mentions Obligatoires</h3>
        <p>Les mentions obligatoires sont les suivantes pour la livraison : Nom, Prénom, mail, numéro de téléphone et adresse postale</p>
        <h3>Livraison en France et en Europe</h3>
        <p>Pour la livraison du livre la prière de Tarawih, il vous suffit de vous rendre ici ou ici pour commander le livre en inscrivant l'intégralité des informations demandées : Nom, prénom, mail, numéro de téléphone et adresse postale. <br><br>
        Concernant le numéro de téléphone, nous n'en ferons aucunement usage sauf cas de nécessité pour le bonne réception du livre. <br><br>
        Après avoir effectué votre commande, vous serez redirigé vers une page de vérification de vos coordonnées, pour confirmation de votre adresse et votre mail. <br><br>
        Ces étapes passées, vous recevrez un mail pour précisant que votre livre sera envoyé, sous un délai de 3 jours à 3 semaines.</p>
        <h3>Livraison Hors-Europe</h3>
        <p>Ce sont exactement les mêmes étapes à suivre que ceux et celles qui vivent en Europe, à la seule différence que nous ferons usage de votre numéro de Téléphone pour la bonne réception de votre livre. <br><br>
        Vous pouvez bien évidemment mettre une adresse complète du bureau de poste de votre localité, afin que le bureau vous contacte lors de la réception de votre livre.</p>
        <a href="accueil">Revenir au Menu d'Accueil</a>
        </div>
    </section>
    ...
    <footer class="section-p1">
        <div id="contact" class="col">
            ...
            <p><strong>Mail : </strong>metmati12@hotmail.fr</p>
