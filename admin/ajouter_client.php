<?php
    ...
    {   
        ...
        {
            $db = Database::connect();
            $statement = $db->prepare('INSERT INTO clients_adresses (nom, prenom, email, telephone, adresse1, adresse2, ville, codepostal, pays, quantiteparticulier, quantitepro) 
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)');
            $statement->execute(array($nomClient,$prenomClient,$emailClient,$telephoneClient,$adresse1Client,$adresse2Client,$villeClient,$codepostalClient,$paysClient,$quantiteparticulierClient, $quantiteproClient));
...
<head>
    ...
    <title>Admin Ajouter-un-client</title>
...
<body>
    ...
    <div id="voiradmin" class="titre-container">
        <h1>Admin : Ajouter un client</h1>
        <a href="index.php">Retour</a>
    </div>
    <section id="ajouterlivreadmin">   
        <form class="form-ajouterlivre" role="form" action="ajouter_client.php" method="post">
